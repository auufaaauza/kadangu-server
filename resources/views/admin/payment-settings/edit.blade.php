...
@section('content')
    ...
    <div class="page-header">
        ...
        <p class="page-subtitle">Update informasi metode pembayaran</p>
    </div>
    
    <div class="card">
        <div class="card-header">
            <h2 class="card-title">Informasi Pembayaran</h2>
            <p class="card-subtitle">Update form di bawah untuk mengubah metode pembayaran</p>
        </div>
        
        <form action="{{ route('admin.payment-settings.update', $paymentSetting) }}" 
              method="POST" 
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select name="type" id="type" class="form-select @error('type') is-invalid @enderror" required>
                            ...
                            <option value="qris" {{ old('type', $paymentSetting->type) === 'qris' ? 'selected' : '' }}>QRIS</option>
                            <option value="bank_account" {{ old('type', $paymentSetting->type) === 'bank_account' ? 'selected' : '' }}>Bank Transfer</option>
                        </select>
                        @error('type')
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('name', $paymentSetting->name) }}"
            ...
            <div id="qrisFields" style="display: none;">
                <div class="mb-3">
                    <label for="qris_image" class="form-label">
                        Gambar QRIS
                        <span class="text-muted">(Max 2MB, JPG/PNG - Kosongkan jika tidak ingin mengubah)</span>
                    </label>
                    <input type="file" 
                           name="qris_image" 
                           id="qris_image" 
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('account_holder', $paymentSetting->account_holder) }}"
                ...
                <div class="col-md-8">
                    <div class="mb-3">
                        ...
                        <textarea name="instructions" 
                                  ...
                                  placeholder="Instruksi tambahan untuk customer">{{ old('instructions', $paymentSetting->instructions) }}</textarea>
                        @error('instructions')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-2">
                    <div class="mb-3">
                        ...
                        <input type="number" 
                               ...
                               value="{{ old('display_order', $paymentSetting->display_order) }}"
                               min="0">
                        @error('display_order')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="col-md-2">
                    <div class="mb-3">
                        ...
                        <select name="is_active" id="is_active" class="form-select">
                            <option value="1" {{ old('is_active', $paymentSetting->is_active) ? 'selected' : '' }}>Active</option>
                            <option value="0" {{ !old('is_active', $paymentSetting->is_active) ? 'selected' : '' }}>Inactive</option>
                        </select>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function toggleFields() {
        ...
        if (type === 'qris') {
            ...
            qrisImage.required = false; // Not required on edit
